...
// var initialUrl = "https://api.themoviedb.org/3/search/keyword?api_key=cc93940bfc0e8ed610b23598baac74fd&query=Australia"
// var themapi_key = "?api_key=cc93940bfc0e8ed610b23598baac74fd";
// var imgLoadedCount = 0;
// var listID = [];
// var id =[];
...
//         console.log(response);
//         for (var x=0; x<response.results.length; x++ ){
//             listID.push(response.results[x].id);
//             // if(response.results[x].poster_path){
//             //     id.push(response.results[x].id);
//             // }            
//         }
...
//     }).then(function (response) {
//         console.log(response);
//         for (var y=0; y<response.results.length; y++ ){

//             if(response.results[y].poster_path){
//                 id.push(response.results[y].id);
//             }            
//         }
//         // loadInitialCarousel(id);
//     })
